...
export default function Hero() {
    return (
        <section className="relative min-h-screen w-full bg-[#050505] overflow-hidden flex items-center pt-24 md:pt-32 font-sans">
            ...
            <div className="container mx-auto px-8 md:px-20 pb-12 md:pb-24 relative z-10">
